...
public abstract class SmoothAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // go up to team prop
        drive.DriveForward(MoveUp, true);
        sleep(500);
        ...
        if (side.equals("left")) {
            ...
            drive.DriveForward(LeftAdjust, true);
        } else if (side.equals("right")) {
            drive.TurnTo(-90);
            sleep(500);

            drive.DriveForward(RightAdjust, true);
        } else {
            drive.DriveLeft(FrontAdjust1, true);
            sleep(500);

            drive.DriveBackward(FrontAdjust2, true);
        }
        sleep(500);
        ...
        // go back
        drive.DriveBackward(MoveBackStraight, true);
        sleep(500);
        ...
        // move up to board
        drive.DriveForward(ParkMove1Straight, true);
        sleep(500);

        // line up with board
        if (Red) {
            drive.DriveLeft(ParkMove2Strafe / 2, true);
        } else {
            drive.DriveRight(ParkMove2Strafe / 2, true);
        }
        sleep(500);
